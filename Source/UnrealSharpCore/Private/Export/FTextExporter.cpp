...
DECLARE_UNREALSHARP_EXPORTER(FTextExporter)
{
	...
	EXPORT_UNREALSHARP_FUNCTION(ToStringView)
	EXPORT_UNREALSHARP_FUNCTION(FromString)
	EXPORT_UNREALSHARP_FUNCTION(FromStringView)
	EXPORT_UNREALSHARP_FUNCTION(FromName)
	EXPORT_UNREALSHARP_FUNCTION(CreateEmptyText)
	EXPORT_UNREALSHARP_FUNCTION(IsCultureInvariant)
	EXPORT_UNREALSHARP_FUNCTION(IsFromStringTable)
	EXPORT_UNREALSHARP_FUNCTION(IsInitializedFromString)
	EXPORT_UNREALSHARP_FUNCTION(IsNumeric)
	EXPORT_UNREALSHARP_FUNCTION(IsEmpty)
}
