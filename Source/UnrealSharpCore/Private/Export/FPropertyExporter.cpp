...
DECLARE_UNREALSHARP_EXPORTER(FPropertyExporter)
{
	...
	EXPORT_UNREALSHARP_FUNCTION(GetNativePropertyFromName)
	EXPORT_UNREALSHARP_FUNCTION(GetPropertyOffset)
	EXPORT_UNREALSHARP_FUNCTION(GetSize)
	EXPORT_UNREALSHARP_FUNCTION(GetArrayDim)
	EXPORT_UNREALSHARP_FUNCTION(DestroyValue)
	EXPORT_UNREALSHARP_FUNCTION(DestroyValue_InContainer)
	EXPORT_UNREALSHARP_FUNCTION(InitializeValue)
	EXPORT_UNREALSHARP_FUNCTION(Identical)
	EXPORT_UNREALSHARP_FUNCTION(GetInnerFields)
	EXPORT_UNREALSHARP_FUNCTION(GetValueTypeHash)
	EXPORT_UNREALSHARP_FUNCTION(HasAnyPropertyFlags)
	EXPORT_UNREALSHARP_FUNCTION(HasAllPropertyFlags)
	EXPORT_UNREALSHARP_FUNCTION(CopySingleValue)
	EXPORT_UNREALSHARP_FUNCTION(GetValue_InContainer)
	EXPORT_UNREALSHARP_FUNCTION(SetValue_InContainer)
	EXPORT_UNREALSHARP_FUNCTION(GetBoolPropertyFieldMaskFromName)
	EXPORT_UNREALSHARP_FUNCTION(GetPropertyOffsetFromName)
	EXPORT_UNREALSHARP_FUNCTION(GetPropertyArrayDimFromName)
	EXPORT_UNREALSHARP_FUNCTION(BroadcastFieldValueChanged)
}