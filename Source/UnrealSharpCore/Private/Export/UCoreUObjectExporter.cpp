...
DECLARE_UNREALSHARP_EXPORTER(UCoreUObjectExporter)
{
	...
	EXPORT_UNREALSHARP_FUNCTION(GetType)
	EXPORT_UNREALSHARP_FUNCTION(GetNativeDelegate)
	EXPORT_UNREALSHARP_FUNCTION(GetGeneratedClassFromSkeleton)
}