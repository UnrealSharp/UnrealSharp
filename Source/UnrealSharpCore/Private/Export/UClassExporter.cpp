...
DECLARE_UNREALSHARP_EXPORTER(UClassExporter)
{
	...
	EXPORT_UNREALSHARP_FUNCTION(GetNativeFunctionFromClassAndName)
	EXPORT_UNREALSHARP_FUNCTION(GetNativeFunctionFromInstanceAndName)
	EXPORT_UNREALSHARP_FUNCTION(GetFirstNativeImplementationFromInstanceAndName)
	EXPORT_UNREALSHARP_FUNCTION(GetDefaultFromName)
	EXPORT_UNREALSHARP_FUNCTION(GetDefaultFromInstance)
	EXPORT_UNREALSHARP_FUNCTION(IsChildOf)
}
