...
public static class PropertyUtilities
{
    ...
    public static bool IsReadWrite(this UhtProperty property)
    {
        ...
        return !isReadOnly && (property.PropertyFlags.HasAnyFlags(EPropertyFlags.Edit | EPropertyFlags.BlueprintVisible | EPropertyFlags.BlueprintAssignable) || property.HasAnySetter());
    }
