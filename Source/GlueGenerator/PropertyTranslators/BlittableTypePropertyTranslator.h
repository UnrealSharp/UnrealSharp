...
public:
	...
	FBlittableTypePropertyTranslator(FPropertyTranslatorManager& InPropertyHandlers, FFieldClass* InPropertyClass, const FString& InCSharpType, EPropertyUsage InPropertyUsage = EPropertyUsage::EPU_Any);
