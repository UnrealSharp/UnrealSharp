...
FBlittableStructPropertyTranslator::FBlittableStructPropertyTranslator(FPropertyTranslatorManager& InPropertyHandlers)
: FBlittableTypePropertyTranslator(InPropertyHandlers, FStructProperty::StaticClass(), "")
{

}

bool FBlittableStructPropertyTranslator::IsStructBlittable(const FPropertyTranslatorManager& PropertyHandlers, const UScriptStruct& Struct)
{
