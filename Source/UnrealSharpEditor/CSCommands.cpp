...
void FCSCommands::RegisterCommands()
{
	...
	UI_COMMAND(MergeManagedSlnAndNativeSln, "Merge Managed.sln and Native.sln", "Merge managed sln and native sln into one mixed.sln, coding in one IDE", EUserInterfaceActionType::Button, FInputChord());
