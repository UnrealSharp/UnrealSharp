...
public static class InterfaceExporter
{
    public static void ExportInterface(UhtClass interfaceObj)
    {
        ...
        stringBuilder.AppendLine($"static readonly IntPtr NativeInterfaceClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName({interfaceObj.ExportGetAssemblyName()}, \"{interfaceObj.EngineName}\");");
        stringBuilder.AppendLine();
