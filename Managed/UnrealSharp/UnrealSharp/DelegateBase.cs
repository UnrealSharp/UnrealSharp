...
public abstract class DelegateBase<TDelegate> : IDelegateBase where TDelegate : class
{
    ...
    public abstract void BindUFunction(UnrealSharpObject targetObject, Name functionName);
    public abstract void BindUFunction(WeakObject<UnrealSharpObject> targetObject, Name functionName);
