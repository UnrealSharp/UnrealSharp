...
public abstract class UnrealArrayBase<T> : IEnumerable<T>
{
    ...
    [CLSCompliant(false)]
    public UnrealArrayBase(UnrealSharpObject ownerSharpObject, IntPtr nativeUnrealProperty, IntPtr nativeBuffer, MarshallingDelegates<T>.ToNative toNative, MarshallingDelegates<T>.FromNative fromNative)
    {
...
{
    [CLSCompliant(false)]
    public UnrealArrayReadOnly(UnrealSharpObject baseSharpObject, IntPtr nativeUnrealProperty, IntPtr nativeBuffer, MarshallingDelegates<T>.ToNative toNative, MarshallingDelegates<T>.FromNative fromNative)
...
{
    [CLSCompliant(false)]
    public UnrealArrayReadWrite(UnrealSharpObject baseSharpObject, IntPtr nativeUnrealProperty, IntPtr nativeBuffer, MarshallingDelegates<T>.ToNative toNative, MarshallingDelegates<T>.FromNative fromNative)
        : base(baseSharpObject, nativeUnrealProperty, nativeBuffer, toNative, fromNative)
    {
    }
...
public class UnrealArrayReadWriteMarshaller<T>(int length, IntPtr nativeProperty, MarshallingDelegates<T>.ToNative toNative, MarshallingDelegates<T>.FromNative fromNative)
{
...
public class UnrealArrayReadOnlyMarshaller<T>
{
    ...
    MarshallingDelegates<T>.FromNative InnerTypeFromNative;

    public UnrealArrayReadOnlyMarshaller(int length, IntPtr nativeProperty, MarshallingDelegates<T>.ToNative toNative, MarshallingDelegates<T>.FromNative fromNative)
    {
...
{
    int ElementSize;
    MarshallingDelegates<T>.ToNative InnerTypeToNative;
    MarshallingDelegates<T>.FromNative InnerTypeFromNative;

    public UnrealArrayCopyMarshaller(int length, MarshallingDelegates<T>.ToNative toNative, MarshallingDelegates<T>.FromNative fromNative, int elementSize)
    {
