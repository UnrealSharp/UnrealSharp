...
public abstract class Delegate<TDelegate> : DelegateBase<TDelegate> where TDelegate : class
{
    ...
    public WeakObject<UnrealSharpObject> TargetObject => new(_data.Object);
    ...
    public Delegate(UnrealSharpObject targetObject, Name functionName)
    {
    ...
    public bool IsBoundToObject(UnrealSharpObject obj)
    {
    ...
    {
        BindUFunction(new WeakObject<UnrealSharpObject>(targetObject), functionName);
    }
