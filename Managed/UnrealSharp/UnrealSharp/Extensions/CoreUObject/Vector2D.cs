...
public partial struct Vector2D
{
    ...
    public static implicit operator Vector2(Vector2D vec) => new Vector2((float)vec.X, (float)vec.Y);
    
    /// <summary>
    /// Returns the vector (0,0).
    /// </summary>
    public static Vector2D Zero => new();
    ...
    {
        return new Vector2D(left, left) * right;
    }
    ...
    {
        return left * new Vector2D(right, right);
    }
