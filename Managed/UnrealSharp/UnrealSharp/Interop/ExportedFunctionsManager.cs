...
public static class ExportedFunctionsManager
{
    ...
    public unsafe static void Initialize(IntPtr nativeExportFunctionsPtr)
    {
        try
        {
            ...
            NativeFunctionDelegate registerFunctions = Marshal.GetDelegateForFunctionPointer<NativeFunctionDelegate>(nativeExportFunctionsPtr);
            IntPtr registerFunctionsCallback = Marshal.GetFunctionPointerForDelegate<RegisterFunctionsCallback>(RegisterFunctions);
