...
[AttributeUsage(AttributeTargets.Class | AttributeTargets.Enum | AttributeTargets.Field | AttributeTargets.Struct | AttributeTargets.Method | AttributeTargets.Property), CustomMetaData]
...
[AttributeUsage(AttributeTargets.Class | AttributeTargets.Struct | AttributeTargets.Method), CustomMetaData]
...
[AttributeUsage(AttributeTargets.Class | AttributeTargets.Property | AttributeTargets.Field | AttributeTargets.Method), CustomMetaData]
...
/// </summary>
[AttributeUsage(AttributeTargets.Class), CustomMetaData]
...
/// </summary>
[AttributeUsage(AttributeTargets.Enum), CustomMetaData]
...
/// </summary>
[AttributeUsage(AttributeTargets.Interface), CustomMetaData]
...
[AttributeUsage(AttributeTargets.Struct), CustomMetaData]
...
[AttributeUsage(AttributeTargets.Method), CustomMetaData]
...
/// </summary>
[AttributeUsage(AttributeTargets.Property | AttributeTargets.Field), CustomMetaData]
...
/// <summary>
/// [BindWidgetOptional]
/// Used for UWidget properties. Indicates that the property should be bound to a widget in the Blueprint Editor. Will not cause an error if not found.
/// </summary>
[AttributeUsage(AttributeTargets.Property | AttributeTargets.Field), CustomMetaData]
