...
{
    private static readonly Dictionary<string, Func<ISymbol, ITypeSymbol, UnrealType, SyntaxNode?, UnrealProperty>>
        ...
        SyntaxNode? syntaxNode = null)
    {
        ...
        if (Factories.TryGetValue(typeSymbol.Name,
                out Func<ISymbol, ITypeSymbol, UnrealType, SyntaxNode?, UnrealProperty>? factory))
        {
        ...
        {
            TypeKind.Delegate => new FieldProperty(memberSymbol,
                DelegateProperty.MakeFieldNameFromDelegateSymbol(typeSymbol), typeSymbol,
                PropertyType.SignatureDelegate, outer, syntaxNode),
            ...
            TypeKind.Struct => typeSymbol.HasAttribute("BlittableTypeAttribute")
                ? new BlittableStructProperty(memberSymbol, typeSymbol, PropertyType.Struct, outer, syntaxNode)
                : new StructProperty(memberSymbol, typeSymbol, outer, syntaxNode),
