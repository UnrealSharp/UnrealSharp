...
public readonly record struct ComponentOverride
{
    ...
    public ComponentOverride(ITypeSymbol owningClass, ITypeSymbol overrideComponentType, string overridePropertyName,
        Accessibility accessibility, string? optionalPropertyName = null)
    {
