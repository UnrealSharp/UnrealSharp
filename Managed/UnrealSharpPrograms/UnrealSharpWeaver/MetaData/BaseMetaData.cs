...
public class BaseMetaData
{
    ...
    {
        CustomAttribute? flagsAttribute = WeaverHelper.FindAttributeByType(customAttributes, Program.UnrealSharpCore + ".Attributes", flagsAttributeName);
    ...
    {
        return WeaverHelper.FindAttributeByType(customAttributes, Program.UnrealSharpCore + ".Attributes", attributeName);
    }
}